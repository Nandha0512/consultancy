...
//         <label className='q'>Add Coimabatore Products</label>
...
const ProductInsert = () => {
  ...
  return (
    ...
    <form onSubmit={submitHandler} enctype="multipart/form-data">
        <label className='q'>Add Coimbatore Products</label>
        <div className="form-body">
            <div className="name">
                <label className="form__label" for="Name">Name </label><br></br>
            ...
            <div className="city">
                ...
                <input className="form__input" type="text" value={stocks} id="city" placeholder="Stocks" onChange={(event) => {
                    setStocks(event.target.value);
                }} />
            </div>
            <div className="city">
